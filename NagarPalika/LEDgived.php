                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">LED Given Those Clients</h1>                            </div>
                    ...
                    <div class="col-lg-12">
                        <section class="box purple">
                            <header class="panel_header">
                                <h2 class="title pull-left">LED Given Those Clients</h2>
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
										...
										<table id="example" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
											...
											<?php
											$isr=0;
												$sqlp="SELECT accounts.id 'acid',accounts.slipno, accounts.name, accounts.fathername, accounts.address, accounts.mobile, accounts.LED, accounts.gift, accounts.smobile, accounts.remarks,acctype.Name 'AccType', agent.Name 'Agent' FROM `accounts`,`acctype`,`agent` WHERE accounts.dealer = agent.id AND accounts.AccType = acctype.id AND accounts.LED != '';";	
