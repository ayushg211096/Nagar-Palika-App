                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Account Types</h1>                            </div>
                    ...
                    <div class="col-lg-12">
                        <section class="box purple">
                            <header class="panel_header">
                                <h2 class="title pull-left">Account Tyeps</h2>
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
										...
										<form action="addAccTypes.php" method="post">
											<div class="col-md-3">
											Name
											<input type="text" name="name" id="name" placeholder="Name" class="form-control input-md" pattern="[a-zA-Z0-9 ]{1,30}" title="name : accept onlya-z ,A-Z or whitespace , Max:30" required/></div>
											<div class="col-md-3">First Month Installment
											<input type="text" id="FMI" name="FMI"  placeholder="First Month Installment" class="form-control input-md" pattern="\d+(\.\d{2})?" title="First Month Installment" required/></div>
											<div class="col-md-3">Other Month Installment
											<input type="text" id="OMI" name="OMI"  placeholder="Other Month Installment" class="form-control input-md" pattern="\d+(\.\d{2})?" title="Other Month Installment" required/></div>
											
											<div class="col-md-3"> &emsp;<input type="submit" value="Add AccType" class="btn btn-primary form-control input-md"  /></div>
										</form>
										</div>
                                        <!-- ********************************************** -->
										...
										<table id="example" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
											...
											<?php
												...
												while($row2=mysqli_fetch_array($res2))
                                                    ...
                                                    <td><?php echo $row2['FMI']; ?></td>
													<td><?php echo $row2['OMI']; ?></td>
													<td><a href="ViewAccType.php?id=<?php echo $row2['id']; ?>" class="btn btn-info">View Clients</a></td>
                                                </tr>
														<?php
													}
												}
