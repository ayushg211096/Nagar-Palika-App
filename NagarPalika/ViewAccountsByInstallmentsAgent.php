                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title"><?php echo $AccDetail['Name']." - ".$im; ?></h1>                            </div>
...
<a href="PayInstallmentsAgent.php?agent=<?php echo $agentid; ?>&month=<?php echo $im; ?>" class="btn btn-info pull-right">Multiple Payment</a>
