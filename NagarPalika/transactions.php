...
<html class=" ">
    <head>
       <?php
	   $pheadtitle="Manage Transactions";
                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Manage Transactions</h1>                            </div>
                    ...
                    <div class="col-lg-12">
                        <section class="box purple">
                            <header class="panel_header">
                                <h2 class="title pull-left">Manage Transactions</h2>
												...
												while($row2=mysqli_fetch_array($res2))
													{
														...
														$name=$row2['name'];
														$status=$row2['status'];
														$full_detail=unserialize($row2['full_detail']);
														//$cvstimestamp=$row2['timestamp'];
														$regid="C4L".(1000+$user_id);
														$sr=$sr+1;
														?>
														 <tr>
                                                    <td><?php echo $sr; ?></td>
                                                    ...
                                                    <td><?php 
														//echo $full_detail;
														foreach ($full_detail as $key => $value) {
															echo "<br />".$key." : ".$value;
														}?>
													</td>
                                                </tr>
