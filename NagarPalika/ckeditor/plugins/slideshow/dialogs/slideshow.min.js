...
CSS_ADDGAL+'" type\x3d"text/css" /\x3e\'); })(jQuery);');e.append(c);c=CKEDITOR.document.createElement("script",{attributes:{type:"text/javascript"}});c.setText(C(b,0,0,0));e.append(c);b.imagesList.length&&(a.backgroundImage='url("'+b.imagesList[0][IMG_PARAM.URL]+'")');a.backgroundSize="50%";a.display="block";e=f.createFakeElement(e,"cke_slideShow","slideShow",!1);e.setAttributes({});e.setStyles(a);b.fakeImage?(e.replace(b.fakeImage),f.getSelection().selectElement(e)):f.insertElement(e);E(b);b.hide()}}],
contents:[{id:"slideshowinfoid",label:"Basic Settings",align:"center",elements:[{type:"text",id:"id",style:"display:none;",onLoad:function(){this.getInputElement().setAttribute("readOnly",!0)}},{type:"text",id:"txturlid",style:"display:none;",label:g.imgList,onChange:function(){var b=this.getDialog(),a=this.getValue();if(0<a.length){var c=b.previewImage;c.on("load",x,b);c.on("error",v,b);c.on("abort",v,b);c.setAttribute("src",a)}}},{type:"button",id:"browse",hidden:"true",style:"display:inline-block;margin-top:0px;",
filebrowser:{action:"Browse",target:"slideshowinfoid:txturlid",url:f.config.filebrowserImageBrowseUrl||f.config.filebrowserBrowseUrl},label:g.imgAdd},{type:"vbox",align:"center",children:[{type:"html",align:"center",id:"framepreviewtitleid",style:"font-family: Amaranth; color: #1E66EB;\tfont-size: 20px; font-weight: bold;",html:g.previewMode},{type:"html",id:"framepreviewid",align:"center",style:"width:500px;height:320px",html:""},{type:"hbox",id:"imgparamsid",style:"display:none;width:500px;",height:"325px",
children:[{type:"vbox",align:"center",width:"400px",children:[{type:"text",id:"imgtitleid",label:g.imgTitle,onChange:function(){var b=this.getDialog(),a=this.getValue();b.imagesList[r(b)][IMG_PARAM.TITLE]=a;w(b)},onBlur:function(){var b=this.getDialog(),a=this.getValue();b.imagesList[r(b)][IMG_PARAM.TITLE]=a;w(b)}},{type:"text",id:"imgdescid",label:g.imgDesc,onChange:function(){var b=this.getDialog(),a=this.getValue();b.imagesList[r(b)][IMG_PARAM.ALT]=a;w(b)},onBlur:function(){var b=this.getDialog(),
a=this.getValue();b.imagesList[r(b)][IMG_PARAM.ALT]=a;w(b)}},{type:"html",id:"imgpreviewid",style:"width:400px;height:200px;",html:"\x3cdiv\x3exx\x3c/div\x3e"}]}]},{type:"hbox",align:"center",height:110,widths:["25%","50%"],children:[{type:"vbox",children:[{type:"checkbox",id:"autostartid",label:g.autoStart,"default":"checked",style:"margin-top:15px;",onChange:m,commit:m,setup:p},{type:"checkbox",id:"showtitleid",label:g.showTitle,"default":"checked",onChange:m,commit:m,setup:p},{type:"checkbox",
id:"showcontrolid",label:g.showControls,"default":"checked",onChange:m,commit:m,setup:p},{type:"checkbox",id:"showthumbid",label:g.showThumbs,"default":"checked",onChange:m,commit:m,setup:p},{type:"checkbox",id:"openOnClickId",label:g.openOnClick,"default":"checked",onChange:m,commit:m,setup:p}]},{type:"select",id:"imglistitemsid",label:g.picturesList,multiple:!1,style:"height:125px;width:250px",items:[],onChange:function(b){b=this;var a=b.getDialog();b=h(b);var c,e,d=0;for(c=0;c<b.getChildren().count();c+=
1)if(e=b.getChild(c),e.$.selected){d=c;break}t(b,d);n(a)}},{type:"vbox",children:[{type:"button",id:"previewbtn",style:"margin-top:15px;margin-left:25px;",label:g.previewMode,onClick:function(){y(this.getDialog())}},{type:"button",id:"removeselectedbtn",style:"margin-left:25px;",label:g.imgDelete,onClick:function(){var b=this.getDialog(),a=b.getContentElement("slideshowinfoid","imglistitemsid"),a=h(a),c,e=!1;for(c=a.getChildren().count()-1;0<=c;c--)a.getChild(c).$.selected&&(b.imagesList.splice(c,
1),a.getChild(c).remove(),e=!0);e&&(0==b.imagesList.length&&(c=BASE_PATH+"plugins/slideshow/images/placeholder.png",k(a,"IMG_0 : "+c.substring(c.lastIndexOf("/")+1),c,b.getParentEditor().document),b.imagesList.pushUnique([c,g.imgTitle,g.imgDesc,"50","50"])),t(a,0),n(b))}},{type:"button",id:"editselectedbtn",style:"margin-left:25px;",label:g.imgEdit,onClick:function(){w(this.getDialog())}},{type:"hbox",children:[{type:"button",id:"upselectedbtn",style:"width:32px; margin-left:25px;",label:g.arrowUp,
onClick:function(){z(this.getDialog(),-1)}},{type:"button",id:"downselectedbtn",style:"width:32px;",label:g.arrowDown,onClick:function(){z(this.getDialog(),1)}}]}]}]},{type:"hbox",children:[{type:"text",id:"pictheightid",label:g.pictHeight,maxLength:3,style:"width:100px;","default":"300",onChange:function(b){0==/^\d+$/.test(this.getValue())&&this.setValue(300);this.getDialog().params.updateVal(this.id,this.getValue());n(this.getDialog())},commit:m,setup:p},{type:"text",id:"speedid",label:g.displayTime,
maxLength:3,style:"width:100px;","default":"5",onChange:function(b){0==/^\d+$/.test(this.getValue())&&this.setValue(5);this.getDialog().params.updateVal(this.id,this.getValue());n(this.getDialog())},commit:m,setup:p},{type:"text",id:"animspeedid",label:g.transitionTime,style:"width:100px;",maxLength:4,"default":"500",onChange:function(b){0==/^\d+$/.test(this.getValue())&&this.setValue(500);this.getDialog().params.updateVal(this.id,this.getValue());n(this.getDialog())},commit:m,setup:p},{type:"select",
id:"transitiontypeid",label:g.transition,items:[[g.tr1,"none"],[g.tr2,"resize"],[g.tr3,"slide-vert"],[g.tr4,"slide-hori"],[g.tr5,"fade"]],"default":"resize",style:"width:100px;",commit:m,setup:p,onChange:m}]}]}]}],onLoad:function(){},onShow:function(){this.dialog=this;this.slideshowDOM=null;this.openCloseStep=!0;var b=this.fakeImage=null;this.imagesList=[];this.params=[];this.previewImage=f.document.createElement("img");this.okRefresh=!0;var a=this.getSelectedElement();if(a&&a.data("cke-real-element-type")&&
"slideShow"==a.data("cke-real-element-type")&&(this.fakeImage=a,b=f.restoreRealElement(a)),b){this.slideshowDOM=b;a=b.getElementsByTag("ul");a=null==a?null:1==a.count()?a.getItem(0):null;if(null==a)return alert("BIG Problem slideShowContainer !!"),!1;var c=b.getAttribute("id");if(null==c)return alert("BIG Problem slideshowid !!"),!1;this.params.push(["slideshowid",c]);for(var e,d,h,l,m,u=a.$.getElementsByTagName("img"),r=this.getContentElement("slideshowinfoid","imglistitemsid"),a=0;a<u.length;a+=
1)e=u[a],c=e.src,d=e.width,0==d&&(d=e.naturalWidth),0==d?(d=50,h=50):(h=e.height,0==h&&(h=e.naturalHeight),0==h&&(d=50,h=50)),d/=h,m=l=50,1<d?m/=d:l*=d,e=this.imagesList.pushUnique([c,e.title,e.alt,l,m]),0<=e&&k(r,"IMG_"+e+" : "+c.substring(c.lastIndexOf("/")+1),c,this.getParentEditor().document);t(r,0);n(this);var p,b=b.$.dataset;for(p in b)this.params.push([p,b[p]]);this.setupContent(this,!0);this.newSlideShowMode=!1}else this.params.push(["slideshowid","cke_"+F(8)+"_slideShow"]),p=this.getContentElement("slideshowinfoid",
"imglistitemsid"),b=BASE_PATH+"plugins/slideshow/images/placeholder.png",k(p,"IMG_0 : "+b.substring(b.lastIndexOf("/")+1),b,this.getParentEditor().document),this.imagesList.pushUnique([b,g.imgTitle,g.imgDesc,"50","50"]),t(p,0),n(this),this.commitContent(this);this.openCloseStep=!1;y(this)},onOk:function(){return!1},onHide:function(){E(this)}}});