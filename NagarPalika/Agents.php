                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Manage Agents</h1>                            </div>
                    ...
                    <div class="col-lg-12">
                        <section class="box purple">
                            <header class="panel_header">
                                <h2 class="title pull-left">Manage Agents</h2>
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
										...
										<div class="col-md-12" style="margin:10px;border:solid 1px black;padding:5px;">
										<h2>Add Agent</h2>
										<form action="addagent.php" method="post">
											<div class="col-md-3"><input type="text" name="name" id="name" placeholder="Name" class="form-control input-md" pattern="[a-zA-Z ]{1,60}" title="name : accept onlya-z ,A-Z or whitespace" required/></div>
											<div class="col-md-3"><input type="text" id="mobile" name="mobile"  placeholder="Mobile No" class="form-control input-md" pattern="[0-9]{10}" title="Mobile No : {accept only 10 digit}" required/></div>
											<div class="col-md-3"><input type="text" name="city" id="city" placeholder="city" class="form-control input-md" pattern="[a-zA-Z ]{1,60}" title="name : accept onlya-z ,A-Z or whitespace" required/></div>
											<div class="col-md-3"><input type="submit" value="Add Agent" class="btn btn-primary form-control input-md"  /></div>
										</form>
										</div>
                                        <!-- ********************************************** -->
									<br /><br /><br />
										<button onclick="PrintElem('x')" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Print</button>
										<div id="x" style="display:none;"><?php include 'print/printAllAgentList.php';?></div>
										<br /><br /><br /><br /><br />
                                        <!-- ********************************************** -->
										<table id="example" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
											...
											<?php
												...
												while($row2=mysqli_fetch_array($res2))
													...
													<td><a href="ViewAgent.php?id=<?php echo $regid; ?>" class="btn btn-info">View Profile</a><a href="AddAccount.php?agentid=<?php echo $regid; ?>" class="btn btn-info">Add Clients</a></td>
                                                </tr>
														<?php
													}
												}
